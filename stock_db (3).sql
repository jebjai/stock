...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2018 at 11:18 AM
...
CREATE TABLE `droppoint` (
  ...
  `droppoint_name` varchar(256) NOT NULL,
  `droppoint_address` varchar(256) NOT NULL,
  `droppoint_location` varchar(256) NOT NULL,
  `droppoint_contact` varchar(256) NOT NULL,
  `droppoint_phone` varchar(256) NOT NULL,
  `droppoint_active` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `droppoint` (`droppoint_id`, `droppoint_name`, `droppoint_address`, `droppoint_location`, `droppoint_contact`, `droppoint_phone`, `droppoint_active`) VALUES
(18, 'ลาดพร้าว', 'ลาดพร้าว', '13.802116, 100.559972', '', '', 1),
(27, 'สำโรง', '234 fgdfgกด้กำพ่ำพ่่าาะัาะัาก พเัะำพัำีพ่่ดาาaa', '13.1212554, 10.2323232', 'สมชาย', '0811222222', 1),
(28, '-/ภ-ภ', '', '11', '', '', 2),
(29, '1212', '12', '1212', '1212', '121212', 1);
...
(7, 'ชอคโกแลต', '../assests/images/stock/213505a8be4296415e.jpg', 11, 7, '18', '1', 1, 1),
(8, 'มะพร้าว', '../assests/images/stock/136715789347d1aea6.jpg', 11, 7, '9', '1200', 1, 1),
(21, 'สตอเบอร์รี', '../assests/images/stock/293405a8be436c608e.jpg', 11, 7, '1', '1', 1, 1),
(22, 'มะม่วง', '../assests/images/stock/180875a8be4415f33e.jpg', 11, 7, '13', '', 1, 1),
(23, 'กล้วย', '../assests/images/stock/11895a8fa79b7361e.jpg', 12, 8, '23', '', 1, 1),
(24, 'ชอคโกแลต', '../assests/images/stock/181855a8febf245b9f.jpg', 12, 8, '12', '', 1, 1);
...
INSERT INTO `stock` (`stock_id`, `droppoint_id`, `product_id`, `stock_quantity`) VALUES
(1, 18, 8, 10);
...
INSERT INTO `users` (`user_id`, `username`, `password`, `email`, `role`, `location`, `vender`) VALUES
(1, 'admin', '5f4dcc3b5aa765d61d8327deb882cf99', '', 'admin', 'all', 'all'),
(2, 'dp1', '5f4dcc3b5aa765d61d8327deb882cf99', '', 'droppoint', 'ลาดพร้าว', ''),
(3, 'vender1', '5f4dcc3b5aa765d61d8327deb882cf99', '', 'vender', '', 'icecream'),
(4, 'dp2', '5f4dcc3b5aa765d61d8327deb882cf99', '', 'droppoint', 'สำโรง', '');
...
--
ALTER TABLE `droppoint`
  MODIFY `droppoint_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
